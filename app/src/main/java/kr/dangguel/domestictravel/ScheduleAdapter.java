...
public class ScheduleAdapter extends BaseExpandableListAdapter {
    ...
    ArrayList<SchduleList> groupList;
    HashMap<Integer, ArrayList> childList;

    public ScheduleAdapter(LayoutInflater inflater, ArrayList<SchduleList> groupList, HashMap<Integer, ArrayList> childList) {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        SchduleList schduleList = groupList.get(groupPosition);
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        TimeSchedule timeSchedule = (TimeSchedule) childList.get(groupPosition).get(childPosition);
        ...
        if (!timeSchedule.detailplan.equals(""))
            memo.setVisibility(View.VISIBLE);
            memo.setText(timeSchedule.detailplan);
        if (timeSchedule.cost.equals("")) {
            ...
            String formatMoney = moneyFormatter.format(Integer.parseInt(timeSchedule.cost));
